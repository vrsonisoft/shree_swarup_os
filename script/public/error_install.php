    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="max-w-2xl w-full">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Error Detected</h1>
                <p class="text-gray-600">Please address the following issues to continue</p>
            </div>
            ...
            <?php if ($GLOBALS['error_type'] == 'php-version') { ?>
                <div class="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg shadow-sm mb-6">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-red-800 mb-2">PHP Version Not Met</h3>
                            <p class="text-red-700 mb-4">Your server's PHP version is lower than the required version <span class="font-semibold">8.3.0</span>. Please upgrade to continue.</p>
