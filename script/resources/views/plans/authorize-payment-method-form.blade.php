<div class="offline_payment">
    <form wire:submit="offlinePaymentSubmit">
        ...
        <div>
            ...
            <x-input type="file" id="offlineUploadFile" class="mt-1 block w-full" wire:model.defer="offlineUploadFile" />
        ...
        <div>
            <div class="my-4">
                ...
                <x-textarea id="description" class="block mt-1 w-full" wire:model.defer="offlineDescription" rows="4" data-gramm="false" />
