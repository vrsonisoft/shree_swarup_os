<x-form-section submit="updatePassword">
    <x-slot name="title">
        {{ __('modules.profile.updatePassword') }}
    </x-slot>

    <x-slot name="description">
        {{ __('modules.profile.ensureAccountSecure') }}
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ __('modules.profile.currentPassword') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ __('modules.profile.newPassword') }}" />
