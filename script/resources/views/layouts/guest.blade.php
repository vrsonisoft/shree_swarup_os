...
<head>
    ...
    <style>
        ...
        /* Customer site RTL (e.g. Arabic): iOS Safari often gains horizontal scroll from
...
<body @class([
    ...
    <div class="mx-auto min-h-svh shadow-md lg:shadow-none w-full min-w-0 max-w-lg overflow-x-hidden lg:max-w-screen-xl">
        ...
        <div class="flex mt-4 min-w-0 overflow-hidden dark:bg-gray-900">
            <div id="main-content" class="w-full h-full min-w-0 max-w-full overflow-x-hidden overflow-y-auto dark:bg-gray-900">
                <main>
                    @yield('content')
