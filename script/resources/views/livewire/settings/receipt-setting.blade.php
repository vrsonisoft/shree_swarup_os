            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div
                        class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-base font-medium text-gray-900 dark:text-white">@lang('modules.settings.receiptFooter')</h4>
                        </div>

                        <div class="space-y-3">
                            <div>
                                <x-label for="footerText" value="{{ __('modules.settings.receiptFooterText') }}" />
                                <input id="footerText" name="footerText" wire:model.defer="footerText"
                                    value="{{ $footerText }}" type="hidden" x-ref="footerTextInput" />

                                <div wire:ignore
                                    class="border border-gray-300 rounded-md mt-2 dark:border-gray-700 dark:bg-gray-300 pt-2 receipt-footer-editor">
                                    <trix-editor
                                        class="trix-content text-sm border-l-0 border-r-0 border-t border-b-0 focus:ring-0 dark:text-gray-300 dark:bg-gray-800 dark:border-gray-600 min-h-[5rem]"
                                        input="footerText" data-gramm="false" x-ref="footerTrixEditor"
                                        x-on:trix-change="$wire.footerText = $event.target.value"
                                        x-init="
                                            if ($refs.footerTrixEditor && $refs.footerTextInput && $refs.footerTextInput.value) {
                                                $refs.footerTrixEditor.editor.loadHTML($refs.footerTextInput.value);
                                            }
                                        "></trix-editor>
                                </div>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    @lang('modules.settings.receiptFooterTextHelp')
                                </p>
                                <x-input-error for="footerText" class="mt-2" />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div x-show="showPreview"
                                        ...
                                        <div class="p-6">
                                            ...
                                            <div class="receipt" style="width: 80mm; margin: 0 auto;">
                                                ...
                                                <div class="footer">
                                                    @if (filled($footerText) && \App\Models\ReceiptSetting::footerTextToPlain($footerText) !== '')
                                                        <div>{!! $footerText !!}</div>
                                                    @else
