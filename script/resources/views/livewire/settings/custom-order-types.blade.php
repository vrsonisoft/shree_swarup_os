<div>
    <div class="p-4">
        ...
        @if ($this->showRoomServiceOrderTypeWarning)
            <div class="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-lg dark:bg-amber-500/10 dark:border-amber-500/30">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="text-sm font-medium text-amber-900 dark:text-amber-200">@lang('modules.settings.roomServiceOrderTypeMissing')</h4>
                        <p class="mt-1 text-sm text-amber-800 dark:text-amber-100/90">@lang('modules.settings.roomServiceOrderTypeMissingDescription')</p>
                    </div>
                </div>
            </div>
        @endif
